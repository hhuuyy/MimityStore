...
<div class="container">
	<div class="row">
				...
				<div class="col-sm-9 col-md-10">
					<div class="filter-value">
						<div class="block-filter-inner box-filter-price">
							<div data-label-reasult="Filter By Price: " data-min="0"
								data-max="500" data-unit="$" class="slider-range-price"
				...
				<div class="col-sm-9 col-md-10">
					<div class="filter-value">
						<ul class="list-color">
							...
							<li class="selected"><a href="#"><span
									style="background: #ffe00c;">blule</span></a></li>
		...
		<h3 class="page-title">
			<span>beauty & perfumes</span> <a href="#"
				class="button-radius compare-link">Compare (1)<span class="icon"></span></a>
		</h3>
					...
					<div class="product-container">
						<div class="inner row">
							<div class="product-left col-sm-6">
								<div class="product-thumb">
									<a class="product-img" href="#"><img
										src="data\option1\p29.jpg" alt="Product"></a> <a
							...
							<div class="product-right col-sm-6">
								...
								<div class="price-box">
									<span class="product-price">$${prods.unitPrice}</span> <span
								...
								<div class="desc">Top zipper closure, two pockets in the
									front, Slit patch pocket in the back. Detachable, adjustable
									shoulder strap. Interior</div>
