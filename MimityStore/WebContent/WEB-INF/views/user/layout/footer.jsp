...
<footer id="footer">
				...
				<div class="row">
					<div class="col-sm-12 col-md-4">
						<div class="block footer-block-box">
							...
							<div class="block-inner">
								<div class="block-info clearfix">Enter your zip code, city
									or country to find the closest EDO Store near you!</div>
					...
					<div class="col-sm-12 col-md-4">
						<div class="block footer-block-box">
							...
							<div class="block-inner">
								<div class="block-info clearfix">Lorem Ipsum is simply
					...
					<div class="col-sm-12 col-md-4">
						<div class="block footer-block-box">
							...
							<div class="block-inner">
								<div class="block-owl">
									<ul class="kt-owl-carousel list-partners" data-nav="true"
										data-autoplay="true" data-loop="true" data-items="1">
										<li class="partner"><a href="#"><img
												src="data\partner1.jpg" alt="partner"></a></li>
										<li class="partner"><a href="#"><img
												src="data\partner2.jpg" alt="partner"></a></li>
										<li class="partner"><a href="#"><img
												src="data\partner3.jpg" alt="partner"></a></li>
									</ul>
								</div>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="block-payment">
					<ul class="list-logo">
						<li><a href="#"><img src="data\payment1.png"
								alt="Payment Logo"></a></li>
						<li><a href="#"><img src="data\payment2.png"
								alt="Payment Logo"></a></li>
						<li><a href="#"><img src="data\payment3.png"
								alt="Payment Logo"></a></li>
						<li><a href="#"><img src="data\payment4.png"
								alt="Payment Logo"></a></li>
					</ul>
				</div>
			</div>
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				<div class="block-coppyright">© 2015 Edo Demo Store. All
					Rights Reserved.</div>
